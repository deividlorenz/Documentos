...
t,E,c]);b.isFunction(a.p.ondblClickRow)&&a.p.ondblClickRow.call(a,b(n).attr("id"),t,E,c)}}).bind("contextmenu",function(c){A=c.target;n=b(A,a.rows).closest("tr.jqgrow");if(b(n).length!==0){a.p.multiselect||b(a).jqGrid("setSelection",n[0].id,true,c);t=n[0].rowIndex;E=b.jgrid.getCellIndex(A);b(a).triggerHandler("jqGridRightClickRow",[b(n).attr("id"),t,E,c]);b.isFunction(a.p.onRightClickRow)&&a.p.onRightClickRow.call(a,b(n).attr("id"),t,E,c)}});c.bDiv=document.createElement("div");k&&"auto"===
...
f&&(e=!1===e?!1:!0,(a=this.rows.namedItem(f+""))&&a.className&&!(-1<a.className.indexOf("ui-state-disabled"))))(!0===this.p.scrollrows&&(h=this.rows.namedItem(f).rowIndex,0<=h&&(d=b(this.grid.bDiv)[0].clientHeight,g=b(this.grid.bDiv)[0].scrollTop,i=this.rows[h].offsetTop,h=this.rows[h].clientHeight,i+h>=d+g?b(this.grid.bDiv)[0].scrollTop=i-(d+g)+h+g:i<d+g&&i<g&&(b(this.grid.bDiv)[0].scrollTop=i))),!0===this.p.frozenColumns&&(j=this.p.id+"_frozen"),this.p.multiselect)?(this.setHeadCheckBox(!1),this.p.selrow=
a.id,g=b.inArray(this.p.selrow,this.p.selarrrow),-1===g?("ui-subgrid"!==a.className&&b(a).addClass("ui-state-highlight").attr("aria-selected","true"),d=!0,this.p.selarrrow.push(this.p.selrow)):("ui-subgrid"!==a.className&&b(a).removeClass("ui-state-highlight").attr("aria-selected","false"),d=!1,this.p.selarrrow.splice(g,1),i=this.p.selarrrow[0],this.p.selrow=void 0===i?null:i),b("#jqg_"+b.jgrid.jqID(this.p.id)+"_"+b.jgrid.jqID(a.id))[this.p.useProp?"prop":"attr"]("checked",d),j&&(-1===g?b("#"+b.jgrid.jqID(f),
"#"+b.jgrid.jqID(j)).addClass("ui-state-highlight"):b("#"+b.jgrid.jqID(f),"#"+b.jgrid.jqID(j)).removeClass("ui-state-highlight"),b("#jqg_"+b.jgrid.jqID(this.p.id)+"_"+b.jgrid.jqID(f),"#"+b.jgrid.jqID(j))[this.p.useProp?"prop":"attr"]("checked",d)),b(this).triggerHandler("jqGridSelectRow",[a.id,d,c]),this.p.onSelectRow&&e&&this.p.onSelectRow.call(this,a.id,d,c)):"ui-subgrid"!==a.className&&(this.p.selrow!=a.id?(b(this.rows.namedItem(this.p.selrow)).removeClass("ui-state-highlight").attr({"aria-selected":"false",
...
(function(a){a.extend(a.jgrid,{template:function(d){var e=a.makeArray(arguments).slice(1),c=0;void 0===d&&(d="");return d.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g,function(d,b){if(isNaN(parseInt(b,10))){for(var a=e[c],h=a.length;h--;)if(b===a[h].nm)return a[h].v;c++}else return c++,e[parseInt(b,10)]})}});a.jgrid.extend({groupingSetup:function(){return this.each(function(){var d=this.p.groupingView;if(null!==d&&("object"===typeof d||a.isFunction(d)))if(d.groupField.length){"undefined"===
...
"_"+d.groupField[e])).is(":visible"),a(this).jqGrid("hideCol",d.groupField[e]));d.summary=[];for(var e=this.p.colModel,c=0,f=e.length;c<f;c++)e[c].summaryType&&d.summary.push({nm:e[c].name,st:e[c].summaryType,v:"",sr:e[c].summaryRound,srt:e[c].summaryRoundType||"round"})}else this.p.grouping=!1;else this.p.grouping=!1})},groupingPrepare:function(d,e,c,f){this.each(function(){for(var b=this.p.groupingView,i=this,h=b.groupField.length,k,j,p=0,g=0;g<h;g++)k=b.groupField[g],j=c[k],void 0!==j&&(0===f?
(b.groups.push({idx:g,dataIndex:k,value:j,startRow:f,cnt:1,summary:[]}),b.lastvalues[g]=j,b.counters[g]={cnt:1,pos:b.groups.length-1,summary:a.extend(!0,[],b.summary)},b.groupSummary[g]&&a.each(b.counters[g].summary,function(){this.v=a.isFunction(this.st)?this.st.call(i,this.v,this.nm,c):a(i).jqGrid("groupingCalculations.handler",this.st,this.v,this.nm,this.sr,this.srt,c)}),b.groups[b.counters[g].pos].summary=b.counters[g].summary):"object"!==typeof j&&b.lastvalues[g]!==j?(b.groups.push({idx:g,dataIndex:k,
value:j,startRow:f,cnt:1,summary:[]}),b.lastvalues[g]=j,p=1,b.counters[g]={cnt:1,pos:b.groups.length-1,summary:a.extend(!0,[],b.summary)},b.groupSummary[g]&&a.each(b.counters[g].summary,function(){this.v=a.isFunction(this.st)?this.st.call(i,this.v,this.nm,c):a(i).jqGrid("groupingCalculations.handler",this.st,this.v,this.nm,this.sr,this.srt,c)}),b.groups[b.counters[g].pos].summary=b.counters[g].summary):1===p?(b.groups.push({idx:g,dataIndex:k,value:j,startRow:f,cnt:1,summary:[]}),b.lastvalues[g]=j,
b.counters[g]={cnt:1,pos:b.groups.length-1,summary:a.extend(!0,[],b.summary)},b.groupSummary[g]&&a.each(b.counters[g].summary,function(){this.v=a.isFunction(this.st)?this.st.call(i,this.v,this.nm,c):a(i).jqGrid("groupingCalculations.handler",this.st,this.v,this.nm,this.sr,this.srt,c)}),b.groups[b.counters[g].pos].summary=b.counters[g].summary):(b.counters[g].cnt+=1,b.groups[b.counters[g].pos].cnt=b.counters[g].cnt,b.groupSummary[g]&&(a.each(b.counters[g].summary,function(){this.v=a.isFunction(this.st)?
this.st.call(i,this.v,this.nm,c):a(i).jqGrid("groupingCalculations.handler",this.st,this.v,this.nm,this.sr,this.srt,c)}),b.groups[b.counters[g].pos].summary=b.counters[g].summary)));e.push(d)});return e},groupingToggle:function(d){this.each(function(){var e=this.p.groupingView,c=d.split("_"),f=parseInt(c[c.length-2],10);c.splice(c.length-2,2);var c=c.join("_"),b=e.minusicon,i=e.plusicon,h=a("#"+a.jgrid.jqID(d)),h=h.length?h[0].nextSibling:null,k=a("#"+a.jgrid.jqID(d)+" span.tree-wrap-"+this.p.direction),
j=!1;if(k.hasClass(b)){if(e.showSummaryOnHide){if(h)for(;h&&!a(h).hasClass("jqfoot");)a(h).hide(),h=h.nextSibling}else if(h)for(;h&&!a(h).hasClass(c+"_"+(""+f))&&!a(h).hasClass(c+"_"+(""+(f-1)));)a(h).hide(),h=h.nextSibling;k.removeClass(b).addClass(i);j=!0}else{if(h)for(;h&&!a(h).hasClass(c+"_"+(""+f))&&!a(h).hasClass(c+"_"+(""+(f-1)));)a(h).show(),h=h.nextSibling;k.removeClass(i).addClass(b)}a(this).triggerHandler("jqGridGroupingClickGroup",[d,j]);a.isFunction(this.p.onClickGroup)&&this.p.onClickGroup.call(this,
d,j)});return!1},groupingRender:function(d,e){return this.each(function(){function c(b,d,a){if(0===d)return a[b];var c=a[b].idx;if(0===c)return a[b];for(;0<=b;b--)if(a[b].idx===c-d)return a[b]}var f=this,b=f.p.groupingView,i="",h="",k,j,p=b.groupCollapse?b.plusicon:b.minusicon,g,w=[],x=b.groupField.length,p=p+(" tree-wrap-"+f.p.direction);a.each(f.p.colModel,function(a,d){for(var c=0;c<x;c++)if(b.groupField[c]===d.name){w[c]=a;break}});var s=0,y=b.groupSummary;y.reverse();a.each(b.groups,function(r,
l){s++;j=f.p.id+"ghead_"+l.idx;k=j+"_"+r;h="<span style='cursor:pointer;' class='ui-icon "+p+"' onclick=\"jQuery('#"+a.jgrid.jqID(f.p.id)+"').jqGrid('groupingToggle','"+k+"');return false;\"></span>";try{g=f.formatter(k,l.value,w[l.idx],l.value)}catch(C){g=l.value}i+='<tr id="'+k+'" role="row" class= "ui-widget-content jqgroup ui-row-'+f.p.direction+" "+j+'"><td style="padding-left:'+12*l.idx+'px;" colspan="'+e+'">'+h+a.jgrid.template(b.groupText[l.idx],g,l.cnt,l.summary)+"</td></tr>";if(x-1===l.idx){for(var m=
b.groups[r+1],o=void 0!==m?b.groups[r+1].startRow:d.length,t=l.startRow;t<o;t++)i+=d[t].join("");var q;if(void 0!==m){for(q=0;q<b.groupField.length&&m.dataIndex!==b.groupField[q];q++);s=b.groupField.length-q}for(m=0;m<s;m++)if(y[m]){o="";b.groupCollapse&&!b.showSummaryOnHide&&(o=' style="display:none;"');i+="<tr"+o+' role="row" class="ui-widget-content jqfoot ui-row-'+f.p.direction+'">';for(var o=c(r,m,b.groups),u=f.p.colModel,v,z=o.cnt,n=0;n<e;n++){var A="<td "+f.formatCol(n,1,"")+">&#160;</td>",
B="{0}";a.each(o.summary,function(){if(this.nm===u[n].name){u[n].summaryTpl&&(B=u[n].summaryTpl);"avg"===this.st.toLowerCase()&&(this.v&&0<z)&&(this.v/=z);try{v=f.formatter("",this.v,n,this)}catch(b){v=this.v}A="<td "+f.formatCol(n,1,"")+">"+a.jgrid.format(B,v)+"</td>";return!1}});i+=A}i+="</tr>"}s=q}});a("#"+a.jgrid.jqID(f.p.id)+" tbody:first").append(i);i=null})},groupingGroupBy:function(d,e){return this.each(function(){"string"===typeof d&&(d=[d]);var c=this.p.groupingView;this.p.grouping=!0;"undefined"===
typeof c.visibiltyOnNextGrouping&&(c.visibiltyOnNextGrouping=[]);var f;for(f=0;f<c.groupField.length;f++)!c.groupColumnShow[f]&&c.visibiltyOnNextGrouping[f]&&a(this).jqGrid("showCol",c.groupField[f]);for(f=0;f<d.length;f++)c.visibiltyOnNextGrouping[f]=a("#"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(d[f])).is(":visible");this.p.groupingView=a.extend(this.p.groupingView,e||{});c.groupField=d;a(this).trigger("reloadGrid")})},groupingRemove:function(d){return this.each(function(){"undefined"===typeof d&&
(d=!0);this.p.grouping=!1;if(!0===d){for(var e=this.p.groupingView,c=0;c<e.groupField.length;c++)!e.groupColumnShow[c]&&e.visibiltyOnNextGrouping[c]&&a(this).jqGrid("showCol",e.groupField);a("tr.jqgroup, tr.jqfoot","#"+a.jgrid.jqID(this.p.id)+" tbody:first").remove();a("tr.jqgrow:hidden","#"+a.jgrid.jqID(this.p.id)+" tbody:first").show()}else a(this).trigger("reloadGrid")})},groupingCalculations:{handler:function(a,e,c,f,b,i){var h={sum:function(){return parseFloat(e||0)+parseFloat(i[c]||0)},min:function(){return""===
e?parseFloat(i[c]||0):Math.min(parseFloat(e),parseFloat(i[c]||0))},max:function(){return""===e?parseFloat(i[c]||0):Math.max(parseFloat(e),parseFloat(i[c]||0))},count:function(){""===e&&(e=0);return i.hasOwnProperty(c)?e+1:0},avg:function(){return h.sum()}};if(!h[a])throw"jqGrid Grouping No such method: "+a;a=h[a]();null!=f&&("fixed"==b?a=a.toFixed(f):(f=Math.pow(10,f),a=Math.round(a*f)/f));return a}}})})(jQuery);
